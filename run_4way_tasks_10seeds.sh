...
#   e.g. quadruped_run_dr__stationary — groups all seeds with the same +experiment and training.nonstationary.
#
# Usage:
#   ./run_4way_tasks_10seeds.sh              # all 4 tasks
#   WANDB_PROJECT=my_proj ./run_4way_tasks_10seeds.sh
#   TASK=quadruped_run ./run_4way_tasks_10seeds.sh   # one task only
#
set -euo pipefail
